...
class NitrogenCalculatorTest(unittest.TestCase):
    ...
    def test_calculate_ammonium_compound_atoms(self):
        ...
        # C molar mass = 12.011
        # O molar mass = 15.999
        # Ammonium molar mass = 14.007 * 2 + 1.008 * 8 + 12.011 + 15.999 * 3 = 28.014 + 8.064 + 12.011 + 47.997 = 96.086
        # N molecules = N grams / Ammonium molar mass * Avogadro
        # N molecules = 90 / 96.086 * 6.02e+23 = 0.9366609079366401 * 6.02e+23 = 5.638698665778574e+23

        # N mole = N grams / Ammonium molar mass = 90 / 96.086 = 0.9366609079366401
        # N 2 mole = 0.9366609079366401 + 0.9366609079366401 = 1.8733218158732803
    ...
    def test_calculate_urea_compound_atoms(self):
        ...
        # C molar mass = 12.011
        # O molar mass = 15.999
        # Urea molar mass = 14.007 * 2 + 1.008 * 4 + 12.011 + 15.999 = 28.014 + 4.032 + 12.011 + 15.999 = 60.056
        # N molecules = N grams / Urea molar mass * Avogadro
        # N molecules = 18 / 60.056 * 6.02e+23 = 0.29972026108964966 * 6.02e+23 = 1.804315971759691e+23

        # N mole = N grams / Urea molar mass = 18 / 60.056 = 0.29972026108964966
        # N 2 mole = 0.29972026108964966 + 0.29972026108964966 = 0.5994405221792993
